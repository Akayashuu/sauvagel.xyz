export const en = {
  ...
  skills: {
    ...
    usedSingular: "shipped project",
    usedPlural: "shipped projects",
    note: "Counted from the projects below, not from a score I give myself.",
  },
  projects: {
    label: "Projects",
  ...
  blog: {
    ...
    all: "All",
    search: "Search",
    searchPlaceholder: "Title, topic, tech",
    project: "Project",
    topics: "Topics",
